  ...
  finishEditHandler = (postData) => {
    ...
    fetch(`${URL}/post-image`, {
      ...
      .then((resData) => {
        ...
        const post = {
          _id: resDataField._id,
          title: resDataField.title,
          content: resDataField.content,
          creator: resDataField.creator,
          createdAt: resDataField.createdAt,
          imagePath: resDataField.imageUrl,
        };
        this.setState((prevState) => {
